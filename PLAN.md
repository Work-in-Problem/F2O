...
- [ ] **True-bare baseline (operator เท่านั้น — ขั้นสุดท้ายของการพิสูจน์)** — ปิด plugin ทั้งเครื่อง (`claude plugin disable f2o@f2o`) → รัน arms นอก repo ตาม `evals/README.md` §5 ข้อ 0 → เทียบกับตัวเลข full-install ของรอบ 2; งาน 08/09/14 ยังต้องเป็น session จริง
